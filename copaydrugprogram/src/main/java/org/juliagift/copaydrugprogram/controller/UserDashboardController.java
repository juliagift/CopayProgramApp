...
public class UserDashboardController {
	...
	public String submitClaim(@AuthenticationPrincipal UserDetails userDetails,
		...
		try {
			...
			// redirectAttributes.addFlashAttribute("message", "Your claim has not been
			// saved");
			return "userDashboard";
		}
	}
	...
	public String deleteUserById(@AuthenticationPrincipal UserDetails userDetails, Model model,
			RedirectAttributes redirectAttributes) {
